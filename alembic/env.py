...
Configures Alembic for async PostgreSQL migrations with HOPE.
"""
...
from hope.infrastructure.database.models import (
    UserModel,
    SessionModel,
    ConsentModel,
    PanicEventModel,
...
def get_url() -> str:
    ...
    # Use sync URL for migrations (Alembic needs sync driver for some operations)
